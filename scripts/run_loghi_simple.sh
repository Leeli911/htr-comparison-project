#!/bin/bash
# Loghi Inference Pipeline - Simplified
...
LAYPA_MODEL_DIR="/mimer/NOBACKUP/groups/naiss2025-22-39/lili_project/loghi_models/laypa/general/baseline"
LOGHI_HTR_MODEL_DIR="/mimer/NOBACKUP/groups/naiss2025-22-39/lili_project/loghi_models/loghi-htr/generic-2023-02-15"
...
export IMAGES_PATH  # 导出环境变量给 Python 使用
...
export TMPDIR  # 导出环境变量给 Python 使用
mkdir -p "$TMPDIR"
